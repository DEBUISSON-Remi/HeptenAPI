...
route::post("demande/add",[DemandeTransportController::class,'add']);
...
route::delete("demande/delete/{id}",[DemandeTransportController::class,'delete']);
...
route::put("demande/edit",[DemandeTransportController::class,'edit']);
